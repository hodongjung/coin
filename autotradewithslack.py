...
access = "rKsNm4SnGNMFHCvDG8zMLxMSkdPShI0lyIO8Ex9G"
secret = "Ea8wZDfxq1o3Z7UTU4PZC4ZEDjzRV1dkCylekp1y"
myToken = "xoxb-2010912372692-2028640180080-YRwGjN2HaCNw0uCC4lMyR9Ir"
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            ma15 = get_ma15("KRW-CBK")
            current_price = get_current_price("KRW-CBK")
            if target_price < current_price and ma15 < current_price:
                krw = get_balance("KRW")
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-CBK", krw*0.9995)
                    post_message(myToken,"#crypto", "BTC buy : " +str(buy_result))
        else:
            btc = upbit.get_balance("BTC")
            if btc > 0.00008:
                sell_result = upbit.sell_market_order("KRW-CBK", btc*0.9995)
